        ...
        <section style={{ marginBottom: '5rem' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '1rem', color: 'var(--color-text-muted)', lineHeight: 1.8, marginBottom: '1.5rem' }}>
                Начиная с небольшой лаборатории в Шымкенте, мы постепенно развивались и сегодня производим более 50 наименований продукции, которая используется в сотнях семей.
              </p>
