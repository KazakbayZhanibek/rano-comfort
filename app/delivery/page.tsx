          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                ...
                { num: '3', title: 'Доставим',         desc: '1–3 дня по Алматы'      },
        ...
        <section style={{
          ...
          <div style={{
            ...
            {[
              ...
              { q: 'Доставляете ли вы за пределы Алматы?',  a: 'Пока доставляем только по Алматы. Для оптовых заказов обращайтесь отдельно.' },
            ].map((faq, i) => (
              <div key={i}>
                <h3 style={{
                  fontFamily: 'var(--font-heading)',
