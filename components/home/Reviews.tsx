...
const reviews = [
  {
    id: 1, name: 'Айгерим С.', city: 'Шымкент',
  ...
  {
    id: 2, name: 'Дмитрий К.', city: 'Шымкент',
  ...
  {
    id: 3, name: 'Жанна М.', city: 'Шымкент',
  ...
  {
    id: 4, name: 'Серик А.', city: 'Шымкент',
  ...
  {
    id: 5, name: 'Мадина Т.', city: 'Шымкент',
    ...
    <section className="section section-alt">
      <div className="container">
        ...
        <p className="section-subtitle">
          Реальные отзывы от наших клиентов из Шымкента
        </p>
