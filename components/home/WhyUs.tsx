...
const reasons = [
  ...
  },
  {
    ...
    text: 'Разрабатываем и тестируем каждый продукт в нашей лаборатории в Шымкенте.',
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" color="var(--color-primary-dark)">
  ...
  },
  {
    ...
    text: 'Доставляем по Шымкенту за 1–3 дня. Бесплатно при заказе от 5 000 ₸.',
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" color="var(--color-primary-dark)">
    ...
    <section className="section">
      <div className="container">
        ...
        <p className="section-subtitle">
          RANO Comfort Service — это качество, которому доверяют сотни семей в Шымкенте
        </p>
